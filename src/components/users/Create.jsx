...
export default function Create() {
  ...
  return (
   ...
   <form onSubmit={sendData}>
    ...
    <Input id={'username'} errors={errors} type={'text'} name={'name'} title={'user name'} changeData={changeData}/>
     
      <Input id={'email'} errors={errors} type={'email'} name={'email'} title={'user email'} changeData={changeData} />
   

    <Input id={'password'} errors={errors} type={'password'}  name={'password'} title={'user password'} changeData={changeData} />
